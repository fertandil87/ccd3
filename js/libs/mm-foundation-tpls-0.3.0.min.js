...
angular.module("mm.foundation", ["mm.foundation.tpls", "mm.foundation.accordion", "mm.foundation.alert", "mm.foundation.bindHtml", "mm.foundation.buttons", "mm.foundation.position", "mm.foundation.dropdownToggle", "mm.foundation.interchange", "mm.foundation.transition", "mm.foundation.modal", "mm.foundation.offcanvas", "mm.foundation.pagination", "mm.foundation.tooltip", "mm.foundation.popover", "mm.foundation.progressbar", "mm.foundation.rating", "mm.foundation.tabs", "mm.foundation.topbar", "mm.foundation.tour", "mm.foundation.typeahead"]), angular.module("mm.foundation.tpls", ["template/accordion/accordion-group.html", "template/accordion/accordion.html", "template/alert/alert.html", "template/modal/backdrop.html", "template/modal/window.html", "template/pagination/pager.html", "template/pagination/pagination.html", "template/tooltip/tooltip-html-unsafe-popup.html", "template/tooltip/tooltip-popup.html", "template/popover/popover.html", "template/progressbar/bar.html", "template/progressbar/progress.html", "template/progressbar/progressbar.html", "template/rating/rating.html", "template/tabs/tab.html", "template/tabs/tabset.html", "template/topbar/has-dropdown.html", "template/topbar/toggle-top-bar.html", "template/topbar/top-bar-dropdown.html", "template/topbar/top-bar-section.html", "template/topbar/top-bar.html", "template/tour/tour.html", "template/typeahead/typeahead-match.html", "template/typeahead/typeahead-popup.html"]), angular.module("mm.foundation.accordion", []).constant("accordionConfig", {closeOthers: !0}).controller("AccordionController", ["$scope", "$attrs", "accordionConfig", function (a, b, c) {
...
}), angular.module("mm.foundation.buttons", []).constant("buttonConfig", {activeClass: "active", toggleEvent: "click"}).controller("ButtonsController", ["buttonConfig", function (a) {
    ...
    }]), angular.module("mm.foundation.dropdownToggle", ["mm.foundation.position"]).directive("dropdownToggle", ["$document", "$location", "$position", function (a, b, c) {
        var d = null, e = angular.noop;
        return{restrict: "CA", scope: {dropdownToggle: "@"}, link: function (b, f) {
                var g = angular.element(a[0].querySelector(b.dropdownToggle));
                b.$watch("$location.path", function () {
                    e()
                }), f.bind("click", function (h) {
                    g = angular.element(a[0].querySelector(b.dropdownToggle));
                    var i = f === d;
                    if (h.preventDefault(), h.stopPropagation(), d && e(), !i && !f.hasClass("disabled") && !f.prop("disabled")) {
                        g.css("display", "block");
                        var j = c.offset(f), k = c.offset(angular.element(g[0].offsetParent));
                        g.css({left: j.left - k.left + "px", top: j.top - k.top + j.height + "px"}), d = f, e = function () {
                            a.unbind("click", e), g.css("display", "none"), e = angular.noop, d = null
                        }, a.bind("click", e)
                    }
                }), g && g.css("display", "none")
            }}
    }]), angular.module("mm.foundation.interchange", []).factory("interchangeQueries", ["$document", function (a) {
        for (var b, c, d = {"default": "only screen", landscape: "only screen and (orientation: landscape)", portrait: "only screen and (orientation: portrait)", retina: "only screen and (-webkit-min-device-pixel-ratio: 2),only screen and (min--moz-device-pixel-ratio: 2),only screen and (-o-min-device-pixel-ratio: 2/1),only screen and (min-device-pixel-ratio: 2),only screen and (min-resolution: 192dpi),only screen and (min-resolution: 2dppx)"}, e = "foundation-mq-", f = ["small", "medium", "large", "xlarge", "xxlarge"], g = angular.element(a[0].querySelector("head")), h = 0; h < f.length; h++)
            g.append('<meta class="' + e + f[h] + '" />'), b = getComputedStyle(g[0].querySelector("meta." + e + f[h])), c = b.fontFamily.replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, ""), d[f[h]] = c;
        return d
    }]).factory("interchangeQueriesManager", ["interchangeQueries", function (a) {
        return{add: function (b, c) {
                return b && c && angular.isString(b) && angular.isString(c) && !a[b] ? (a[b] = c, !0) : !1
            }}
    }]).factory("interchangeTools", ["$window", "interchangeQueries", function (a, b) {
        var c = function (a) {
            for (var b, c = a.split(/\[(.*?)\]/), d = c.length, e = /^(.+)\,\ \((.+)\)$/, f = {}; d--; )
                c[d].replace(/[\W\d]+/, "").length > 4 && (b = e.exec(c[d]), b && 3 === b.length && (f[b[2]] = b[1]));
            return f
        }, d = function (c) {
            var d, e, f;
            for (d in c)
                if (e = b[d] || d, f = a.matchMedia(e), f.matches)
                    return c[d]
        };
        return{parseAttribute: c, findCurrentMediaFile: d}
    }]).directive("interchange", ["$window", "$rootScope", "interchangeTools", function (a, b, c) {
        var d = /[A-Za-z0-9-_]+\.(jpg|jpeg|png|gif|bmp|tiff)\ *,/i;
        return{restrict: "A", scope: !0, priority: 450, compile: function (e, f) {
                return"DIV" !== e[0].nodeName || d.test(f.interchange) || e.html('<ng-include src="currentFile"></ng-include>'), {pre: function () {
                    }, post: function (d, e, f) {
                        var g, h;
                        switch (h = e && e[0] && e[0].nodeName, d.fileMap = c.parseAttribute(f.interchange), h) {
                            case"DIV":
    ...
    return{createNew: function () {
        ...
        return{restrict: "EA", scope: {index: "@", animate: "="}, replace: !0, transclude: !0, templateUrl: "template/modal/window.html", link: function (a, c, d) {
                a.windowClass = d.windowClass || "", b(function () {
                    a.animate = !0, c[0].focus()
                })
            }}
    ...
    return a
        ...
        return{scope: {}, restrict: "C", link: function (b, c) {
        ...
        return{require: "^offCanvasWrap", restrict: "C", link: function (a, b, c, d) {
                b.on("click", function () {
                    d.leftToggle()
                })
            }}
                        ...
                        return function (b, c, d) {
                            ...
                            var t, u, v, w = angular.isDefined(o.appendToBody) ? o.appendToBody : !1, x = n(void 0), y = !1, z = angular.isDefined(d[l + "Enable"]), A = function () {
                                ...
                                switch (a = w ? j.offset(c) : j.position(c), d = t.prop("offsetWidth"), e = t.prop("offsetHeight"), b.tt_placement) {
                                    case"right":
                                        f = {top: a.top + a.height / 2 - e / 2, left: a.left + a.width + 10};
                                        break;
                                    case"bottom":
                                        f = {top: a.top + a.height + 10, left: a.left};
                                        break;
                                    case"left":
                                        f = {top: a.top + a.height / 2 - e / 2, left: a.left - d - 10};
                                        break;
                                    default:
                                        f = {top: a.top - e - 10, left: a.left}
                                }
                            ...
                            d.$observe(l + "Trigger", function (a) {
                                B(), C(), x = n(a), angular.isFunction(x.show) ? C = b.$watch(function () {
                                    ...
                                    return g(a ? p : q)
                                }) : x.show === x.hide ? c.bind(x.show, f) : (c.bind(x.show, k), c.bind(x.hide, m)), y = !0
                            });
    ...
    }]), angular.module("mm.foundation.progressbar", ["mm.foundation.transition"]).constant("progressConfig", {animate: !0, max: 100}).controller("ProgressController", ["$scope", "$attrs", "progressConfig", "$transition", function (a, b, c, d) {
    ...
    return{restrict: "EA", replace: !0, transclude: !0, controller: "ProgressController", scope: {value: "=", type: "@"}, templateUrl: "template/progressbar/progressbar.html", link: function (a, b, c, d) {
...
}), angular.module("mm.foundation.rating", []).constant("ratingConfig", {max: 5, stateOn: null, stateOff: null}).controller("RatingController", ["$scope", "$attrs", "$parse", "ratingConfig", function (a, b, c, d) {
        this.maxRange = angular.isDefined(b.max) ? a.$parent.$eval(b.max) : d.max, this.stateOn = angular.isDefined(b.stateOn) ? a.$parent.$eval(b.stateOn) : d.stateOn, this.stateOff = angular.isDefined(b.stateOff) ? a.$parent.$eval(b.stateOff) : d.stateOff, this.createRateObjects = function (a) {
            for (var b = {stateOn: this.stateOn, stateOff: this.stateOff}, c = 0, d = a.length; d > c; c++)
    ...
    return{restrict: "A", require: "^tabset", link: function (b, c, d) {
...
}), angular.module("mm.foundation.topbar", []).factory("closest", [function () {
        return function (a, b) {
    ...
    }]).directive("topBar", ["$timeout", "$compile", "$window", "$document", function (a, b, c, d) {
        var e = angular.element(c), f = angular.element(d[0].querySelector("head"));
        f.append('<meta class="foundation-mq-topbar" />'), f.append('<meta class="foundation-mq-small" />'), f.append('<meta class="foundation-mq-medium" />'), f.append('<meta class="foundation-mq-large" />');
        var g = c.matchMedia || function (a) {
        ...
        return{scope: {stickyClass: "@", backText: "@", stickyOn: "=", customBackText: "=", isHover: "=", mobileShowParentLink: "=", scrolltop: "="}, restrict: "EA", replace: !0, templateUrl: "template/topbar/top-bar.html", transclude: !0, link: function (a, b) {
                var g = a.topbar = b, h = g.parent(), i = /^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, j = (a.mediaQueries = {topbar: getComputedStyle(f[0].querySelector("meta.foundation-mq-topbar")).fontFamily.replace(i, ""), small: getComputedStyle(f[0].querySelector("meta.foundation-mq-small")).fontFamily.replace(i, ""), medium: getComputedStyle(f[0].querySelector("meta.foundation-mq-medium")).fontFamily.replace(i, ""), large: getComputedStyle(f[0].querySelector("meta.foundation-mq-large")).fontFamily.replace(i, "")}, angular.element(d[0].querySelector("body"))), k = a.isSticky = function () {
                    var b = h.hasClass(a.settings.stickyClass);
                    return b && "all" === a.settings.stickyOn ? !0 : b && small() && "small" === a.settings.stickyOn ? !0 : b && medium() && "medium" === a.settings.stickyOn ? !0 : b && large() && "large" === a.settings.stickyOn ? !0 : !1
                }, l = function () {
                    if (a.stickyTopbar && a.isSticky()) {
                        var b = angular.element(d[0].querySelector("." + a.settings.stickyClass)), c = m;
                        e.scrollTop() > c && !b.hasClass("fixed") ? (b.addClass("fixed"), j.css("padding-top", a.originalHeight + "px")) : e.scrollTop() <= c && b.hasClass("fixed") && (b.removeClass("fixed"), j.css("padding-top", ""))
                    }
                };
                if (a.toggle = function (b) {
                    if (!a.breakpoint())
                        return!1;
                    var d = void 0 === b ? !g.hasClass("expanded") : b;
                    d ? g.addClass("expanded") : g.removeClass("expanded"), a.settings.scrolltop ? !d && g.hasClass("fixed") ? (g.parent().addClass("fixed"), g.removeClass("fixed"), j.css("padding-top", a.originalHeight + "px")) : d && g.parent().hasClass("fixed") && (g.parent().removeClass("fixed"), g.addClass("fixed"), j.css("padding-top", ""), c.scrollTo(0, 0)) : (k() && g.parent().addClass("fixed"), g.parent().hasClass("fixed") && (d ? (g.addClass("fixed"), g.parent().addClass("expanded"), j.css("padding-top", a.originalHeight + "px")) : (g.removeClass("fixed"), g.parent().removeClass("expanded"), l())))
                }, h.hasClass("fixed") || k()) {
                    a.stickyTopbar = !0, a.height = h[0].offsetHeight;
                    var m = h[0].getBoundingClientRect().top
                } else
                    a.height = g[0].offsetHeight;
                a.originalHeight = a.height, a.$watch("height", function (a) {
                    a ? g.css("height", a + "px") : g.css("height", "")
                }), e.bind("resize", function () {
                    var b = angular.element(g[0].querySelectorAll("section"));
                    angular.forEach(b, function (a) {
                        angular.element(a.querySelectorAll("li.moved")).removeClass("moved")
                    }), g.removeClass("expanded"), a.height = "", a.$apply()
                }), e.bind("scroll", function () {
                    l(), a.$apply()
                }), a.$on("$destroy", function () {
                    e.unbind("scroll"), e.unbind("resize")
                }), h.hasClass("fixed") && j.css("padding-top", a.originalHeight + "px")
            }, controller: ["$window", "$scope", "closest", function (b, c, e) {
                    ...
                    }, h = c.breakpoint = this.breakpoint = function () {
                        return!g(c.mediaQueries.topbar).matches
                    }, i = [];
                    ...
                    var j = /rtl/i.test(d.find("html").attr("dir")) ? "right" : "left";
                    c.$watch("index", function (a) {
                        ...
                        if (!(c.index < 1) && h()) {
                            var d = angular.element(b.currentTarget), g = e(d, "li.moved"), i = g.parent();
                            c.index = c.index - 1, c.height = 0 === c.index ? "" : c.originalHeight + f(i[0]), a(function () {
                                g.removeClass("moved")
                            }, 300)
                        }
                        ...
                        if (!h())
                            return!1;
                        var b = angular.element(a.currentTarget), d = e(b, "li");
                        d.addClass("moved"), c.height = c.originalHeight + f(b.parent()[0].querySelector("ul")), c.index = c.index + 1, c.$apply()
                    }
                }]}
    }]).directive("toggleTopBar", ["closest", function (a) {
        return{scope: {}, require: "^topBar", restrict: "A", replace: !0, templateUrl: "template/topbar/toggle-top-bar.html", transclude: !0, link: function (b, c, d, e) {
        ...
        return{scope: {}, require: "^topBar", restrict: "EA", replace: !0, templateUrl: "template/topbar/top-bar-section.html", transclude: !0, link: function (a, c, d, e) {
                var f = c;
                a.reset = function () {
                    angular.element(f[0].querySelectorAll("li.moved")).removeClass("moved")
                }, a.move = function (a, b) {
                    f.css("left" === a ? {left: -100 * b + "%"} : {right: -100 * b + "%"})
        ...
        return{scope: {}, require: ["^topBar"], restrict: "A", templateUrl: "template/topbar/has-dropdown.html", replace: !0, transclude: !0, link: function (a, b, c, d) {
                var e = d[0], f = d[1];
                a.triggerLink = b.children("a")[0];
                var g = angular.element(a.triggerLink);
                g.bind("click", function (a) {
                    e.forward(a)
                }), a.$on("$destroy", function () {
                    g.unbind("click")
                }), b.bind("mouseenter", function () {
                    e.settings.isHover && !e.breakpoint() && b.addClass("not-click")
                }), b.bind("click", function () {
                    e.settings.isHover || e.breakpoint() || b.toggleClass("not-click")
                }), b.bind("mouseleave", function () {
                    b.removeClass("not-click")
                }), a.$on("$destroy", function () {
                    b.unbind("click"), b.unbind("mouseenter"), b.unbind("mouseleave"), f.removeDropdown(a)
                })
            }, controller: ["$window", "$scope", function (a, b) {
                    this.triggerLink = b.triggerLink
                }]}
    }]).directive("topBarDropdown", ["$compile", function (a) {
        return{scope: {}, require: ["^topBar", "^hasDropdown"], restrict: "A", replace: !0, templateUrl: "template/topbar/top-bar-dropdown.html", transclude: !0, link: function (b, c, d, e) {
                ...
                var j;
                j = angular.element(f.settings.mobileShowParentLink && i && i.length > 1 ? '<li class="title back js-generated"><h5><a href="#" ng-click="back($event);">{{backText}}</a></h5></li><li><a class="parent-link js-generated" href="' + i + '">{{linkText}}</a></li>' : '<li class="title back js-generated"><h5><a href="" ng-click="back($event);">{{backText}}</a></h5></li>'), a(j)(b), c.prepend(j)
            }}
        ...
        return{restrict: "EA", replace: !0, scope: {title: "@", content: "@", placement: "@", animation: "&", isOpen: "&"}, templateUrl: "template/tour/tour.html", link: function (b, c) {
                        ...
                        if (a === l.$viewValue && m) {
                            if (c.length > 0) {
                                ...
                                for (var d = 0; d < c.length; d++)
                                    b[v.itemName] = c[d], x.matches.push({label: v.viewMapper(x, b), model: c[d]});
